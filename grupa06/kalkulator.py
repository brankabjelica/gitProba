...
button_1= Button(text="1", padx=40, pady=10, command= lambda: button_click(1))
button_2= Button(text="2", padx=40, pady=10, command= lambda: button_click(2))
button_3= Button(text="3", padx=40, pady=10, command=lambda: button_click(3))
button_4= Button(text="4", padx=40, pady=10, command=lambda: butoon_click(4))
button_5= Button(text="5", padx=40, pady=10, command= lambda: button_click(5))
...
button_subtrackt= Button(text="-", padx=41, pady=20, command=button_subtrackt)
button_multiply= Button(text="*", padx=40, pady=20, command=button_multiply)
button_divide= Button(text="/", padx=41, pady=20, command=button_divide)
